    ...
    <div className="space-y-6 font-sans">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-extrabold text-white flex items-center gap-2">
            <FiUsers className="text-indigo-400" /> Employee Directory & Account Management
          </h1>
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 p-4 backdrop-blur-md overflow-y-auto">
          <div className="relative max-w-lg w-full rounded-3xl bg-slate-900 p-6 sm:p-8 border border-slate-800 space-y-6 shadow-2xl my-8 text-slate-200">
            <div className="flex items-center justify-between border-b border-slate-800 pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white">Register New Employee</h3>
                  <p className="text-xs text-slate-400">Create employee profile and auto-generate Employee ID</p>
                </div>
              </div>
              <button
            ...
            <form onSubmit={handleCreateSubmit} className="space-y-4 text-xs">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl bg-slate-950 border border-slate-800 pl-10 pr-4 py-2.5 text-white placeholder-slate-500 focus:border-indigo-500 focus:outline-none"
              ...
              <div>
                <label className="mb-1 block font-bold text-slate-300">Email Address</label>
                <div className="relative">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                  <label className="mb-1 block font-bold text-slate-300">Initial Password</label>
                  <div className="relative">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  <label className="mb-1 block font-bold text-slate-300">Department</label>
                  <input
                    type="text"
                    required
                    value={newEmp.department}
                    onChange={(e) => setNewEmp({ ...newEmp, department: e.target.value })}
                    className="w-full rounded-xl bg-slate-950 border border-slate-800 px-4 py-2.5 text-white placeholder-slate-500 focus:border-indigo-500 focus:outline-none"
                    placeholder="Software Engineering"
                  />
                </div>

                <div>
                  <label className="mb-1 block font-bold text-slate-300">Designation</label>
                  <input
                    type="text"
                    required
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-800">
                <button
                  type="button"
                  onClick={() => setIsAddModalOpen(false)}
                  className="rounded-xl border border-slate-700 bg-slate-800 px-4 py-2.5 font-semibold text-slate-300 hover:bg-slate-700 transition"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="rounded-xl bg-indigo-600 px-6 py-2.5 font-bold text-white shadow-lg hover:bg-indigo-500 disabled:opacity-50 transition"
                >
