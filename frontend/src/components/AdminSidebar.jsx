      ...
      >
        ...
        <div className="border-t border-slate-200 dark:border-slate-800 p-4 space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-between gap-3 rounded-2xl bg-slate-50 dark:bg-slate-950 p-3 border border-slate-200 dark:border-slate-800 hover:border-orange-300 dark:hover:border-orange-500 transition group text-left"
          ...
          >
            <div className="flex items-center gap-2.5 overflow-hidden">
              <img
                ...
                alt="Admin"
                className="h-8 w-8 rounded-xl object-cover border border-slate-200 dark:border-slate-700 shrink-0"
                onError={(e) => {
              ...
              <div className="truncate">
                <p className="text-xs font-extrabold text-slate-900 dark:text-white truncate group-hover:text-orange-600 dark:group-hover:text-orange-400">{user?.full_name || "Admin"}</p>
