      ...
      >
        <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-extrabold tracking-wide text-slate-900 dark:text-white">GeoTrack</p>
        ...
        <div className="border-t border-slate-200 dark:border-slate-800 p-4 space-y-3">
          ...
          <div className="flex items-center gap-3 rounded-xl bg-slate-50 dark:bg-slate-950 p-3 border border-slate-200 dark:border-slate-800">
            <img
            ...
            <div className="truncate">
              ...
              <p className="text-[10px] text-slate-500 dark:text-slate-400 font-mono truncate">{user?.employee_id}</p>
            </div>
          </div>
